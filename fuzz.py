...
if args.command == "discover" and args.custom_auth == "dvwa":
    """ on localhost, if the url argument is simply localhost, it needs to be followed by custom-auth
        i.e. "{url}/{custom-auth}/setup.php", "{url}/{custom-auth}/security.php" etc
